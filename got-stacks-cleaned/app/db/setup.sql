...
CREATE USER IF NOT EXISTS 'redpwnuser'@'%' IDENTIFIED WITH mysql_native_password BY 'redpwnpassword';

GRANT FILE on *.* to 'redpwnuser'@'%';
GRANT SELECT on gotstacks.* to 'redpwnuser'@'%';
GRANT INSERT on gotstacks.* to 'redpwnuser'@'%';
